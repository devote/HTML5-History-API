...
a.returnValue=o))}function S(a){var b=f.getElementById(a=(a||"").replace(/^#/,""));b&&(b.id===a&&"A"===b.nodeName)&&(a=b.getBoundingClientRect(),e.scrollTo(H.scrollLeft||0,a.top+(H.scrollTop||0)-(H.clientTop||0)))}function ea(){var a=f.getElementsByTagName("script"),a=(a[a.length-1]||{}).src||"";(-1!==a.indexOf("?")?a.split("?").pop():"").replace(/(\w+)(?:=([^&]*))?/g,function(a,b,c){c=(c||"").replace(/^(0|false)$/,"");k[b]="basepath"===b?c.replace(/(?:^|\/)[^\/]*$/,"/"):c});fa();u(v+"hashchange",
K,o);var b=[J,s,ga,e,T,l];G&&delete T.state;for(var c=0;c<b.length;c+=2)for(var d in b[c])if(b[c].hasOwnProperty(d))if("function"===typeof b[c][d])b[c+1][d]=b[c][d];else{a=$(b[c],d,b[c][d]);if(!w(b[c+1],d,a,function(a,d){if(d===l)e.history=l=b[c+1]=a}))return O(v+"hashchange",K,o),o;b[c+1]===e&&(y[d]=y[d.substr(2)]=[])}k.redirect&&l.redirect();!G&&q&&Y();if(!m)f[L](v+"click",da,o);"complete"===f.readyState?R(i):(!m&&h().c!==k.basepath&&(C=i),u(v+"load",R,o));return i}function fa(){function a(a){var b=
[],d="VBHistoryClass"+(new Date).getTime()+c++,f=["Class "+d],g;for(g in a)if(a.hasOwnProperty(g)){var h=a[g];h&&(h.get||h.set)?(h.get&&f.push("Public "+("_"===g?"Default ":"")+"Property Get ["+g+"]","Call VBCVal([(accessors)].["+g+"].get.call(me),["+g+"])","End Property"),h.set&&f.push("Public Property Let ["+g+"](val)",h="Call [(accessors)].["+g+"].set.call(me,val)\nEnd Property","Public Property Set ["+g+"](val)",h)):(b.push(g),f.push("Public ["+g+"]"))}f.push("Private [(accessors)]","Private Sub Class_Initialize()",
"Set [(accessors)]="+d+"FactoryJS()","End Sub","End Class","Function "+d+"Factory()","Set "+d+"Factory=New "+d,"End Function");e.execScript(f.join("\n"),"VBScript");e[d+"FactoryJS"]=function(){return a};d=e[d+"Factory"]();for(f=0;f<b.length;f++)d[b[f]]=a[b[f]];return d}function b(a){var b=/[\\"\u0000-\u001f\u007f-\u009f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,c={"\u0008":"\\b","\t":"\\t","\n":"\\n","\u000c":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"};
return b.test(a)?'"'+a.replace(b,function(a){return a in c?c[a]:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}var c=e.eval&&eval("/*@cc_on 1;@*/");if(c&&!(f.documentMode&&7<f.documentMode)){var g=w,k=h().a,m=f.createElement("iframe");m.src="javascript:true;";m=H.firstChild.appendChild(m).contentWindow;e.execScript("Public history\nFunction VBCVal(o,r) If IsObject(o) Then Set r=o Else r=o End If End Function","VBScript");s={_:{get:J.toString}};l={back:n.back,forward:n.forward,
go:n.go,emulate:j,_:{get:function(){return"[object History]"}}};q={parse:function(a){try{return(new Function("","return "+a))()}catch(b){return j}},stringify:function(a){var c=(typeof a).charCodeAt(2);if(114===c)a=b(a);else if(109===c)a=isFinite(a)?""+a:"null";else if(111===c||108===c)a=""+a;else if(106===c)if(a){var d=(c="[object Array]"===E.prototype.toString.call(a))?"[":"{";if(c)for(var e=0;e<a.length;e++)d+=(0==e?"":",")+q.stringify(a[e]);else for(e in a)a.hasOwnProperty(e)&&(d+=(1==d.length?
"":",")+b(e)+":"+q.stringify(a[e]));a=d+(c?"]":"}")}else a="null";else a="void 0";return a}};r=function(a,b,c,e,f){var g=m.document,b=h(b);C=o;if(b.c===h().c&&!f)a&&(p[d.href]=a);else{z=e;if(c)m.lfirst?(history.back(),r(a,b.a,0,e,1)):d.replace("#"+b.d);else if(b.a!=k||f)m.lfirst?f&&(f=0,a=p[d.href]):(m.lfirst=1,r(a,k,0,e,1)),g.open(),g.write('<script>lfirst=1;parent.location.hash="'+b.d.replace(/"/g,'\\"')+'";<\/script>'),g.close();!f&&a&&(p[d.href]=a)}};w=function(b,c,d,f){g.apply(this,arguments)||
(b===s?s[c]=d:b===l?(l[c]=d,"state"===c&&(s=a(s),e.history=l=a(l),e.execScript("var history = window.history;","JavaScript"))):b[c]=d.get&&d.get());return b};setInterval(function(){var a=h().a;if(a!=k){var b=f.createEventObject();b.oldURL=k;b.newURL=k=a;b.type="hashchange";K(b)}},100);e.JSON=q}}if(e.history){var f=e.document,H=f.documentElement,E=e.Object,q=e.JSON,d=e.location,n=e.history,l=n,M=n.pushState,U=n.replaceState,m=!!M,G="state"in n,B=E.defineProperty,s=w({},"t")?{}:f.createElement("a"),
v="",L=e.addEventListener?"addEventListener":(v="on")&&"attachEvent",V=e.removeEventListener?"removeEventListener":"detachEvent",W=e.dispatchEvent?"dispatchEvent":"fireEvent",u=e[L],O=e[V],ca=e[W],k={basepath:"/",redirect:0,type:"/"},D="__historyAPI__",N=f.createElement("a"),z=d.href,Q="",C=o,p={},y={},A=f.title,ga={onhashchange:j,onpopstate:j},X=function(a,b){var c=e.history!==n;c&&(e.history=n);a.apply(n,b);c&&(e.history=l)},T={redirect:function(a,b){k.basepath=b=(""+(b==j?k.basepath:b)).replace(/(?:^|\/)[^\/]*$/,
"/");k.type=a=a==j?k.type:a;if(e.top==e.self){var c=h(j,o,i).c,f=d.pathname+d.search;m?(f=f.replace(/([^\/])$/,"$1/"),c!=b&&RegExp("^"+b+"$","i").test(f)&&d.replace(c)):f!=b&&(f=f.replace(/([^\/])\?/,"$1/?"),RegExp("^"+b,"i").test(f)&&d.replace(b+"#"+f.replace(RegExp("^"+b,"i"),a)+d.hash))}},pushState:function(a,b,c){var d=f.title;A!=j&&(f.title=A);M&&X(M,arguments);r(a,c);f.title=d;A=b},replaceState:function(a,b,c){var e=f.title;A!=j&&(f.title=A);delete p[d.href];U&&X(U,arguments);r(a,c,i);f.title=
e;A=b},location:{set:function(a){e.location=a},get:function(){return m?d:s}},state:{get:function(){return p[d.href]||j}}},J={assign:function(a){0===(""+a).indexOf("#")?r(j,a):d.assign(a)},reload:function(){d.reload()},replace:function(a){0===(""+a).indexOf("#")?r(j,a,i):d.replace(a)},toString:function(){return this.href},href:{get:function(){return h().a}},protocol:j,host:j,hostname:j,port:j,pathname:{get:function(){return h().e}},search:{get:function(){return h().f}},hash:{set:function(a){r(j,(""+
a).replace(/^(#|)/,"#"),o,z)},get:function(){return h().b}}};ea()&&(l.emulate=!m,e[L]=aa,e[V]=ba,e[W]=F)}})(window);
