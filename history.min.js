...
[])[1]||0),$=(new Date).getTime(),x=(A||B)&&(!y||8<y)?0:1,i=8>y?m.createElement("iframe"):s,D,E,F,J="",K=(D="addEventListener",e[D])||(D="attachEvent",J="on",e[D]),ca=(E="removeEventListener",e[E])||(E="detachEvent",e[E]),da=(F="dispatchEvent",e[F])||(F="fireEvent",e[F]),L=[],y=[],Q=0,w={onpopstate:L,popstate:L,onhashchange:y,hashchange:y},t=function(){var a,c,g,d={basepath:"/",redirect:0,type:"/"};g=m.getElementsByTagName("SCRIPT");for(a=0;g[a];a++)if(c=/(.*)\/(?:history|spike)(?:-\d\.\d(?:\.\d)?\w?)?(?:\.min)?.js\?(.*)$/i.exec(g[a].src)||
...
l();i?a!=c.e&&(n.pushState(j,j,c.c+a),Y({oldURL:c.a})):f.hash="#"+c.c+a},get:function(){return l().e}}},I=v.stringify||function(a){function c(d){var b,f,h;b=(typeof d).charCodeAt(2);if(114===b)d=e(d);else if(109===b)d=isFinite(d)?String(d):"null";else if(111===b||108===b)d=String(d);else if(106===b)if(d){f=(b="[object Array]"===ba.apply(d))?"[":"{";if(b)for(h=0;h<d.length;h++)f+=(0==h?"":",")+c(d[h]);else for(h in d)C.call(d,h)&&d[h]!==a&&(f+=(1==f.length?"":",")+e(h)+":"+c(d[h]));d=f+(b?"]":"}")}else d=
"null";else d=a;return d}function e(a){var b=/[\\\"\u0000-\u001f\u007f-\u009f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,c={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"};b.lastIndex=0;return b.test(a)?'"'+a.replace(b,function(a){var b=c[a];return"string"===typeof b?b:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}return c}(),O=function(){var a=v.parse;return function(c){return c?a?a(c):(new Function("return "+
