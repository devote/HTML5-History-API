...
(c.a!==b.a&&(l.location.hash=b.a),O(b.a),a.preventDefault?a.preventDefault():a.returnValue=n))}function O(a){var b=g.getElementById(a=(a||"").replace(/^#/,""));b&&b.id===a&&"A"===b.nodeName&&(a=b.getBoundingClientRect(),e.scrollTo(E.scrollLeft||0,a.top+(E.scrollTop||0)-(E.clientTop||0)))}var g=e.document,E=g.documentElement,w=e.sessionStorage,D=e.Object,P=e.JSON,f=e.location,s=e.history,l=s,F=s.pushState,Q=s.replaceState,p=!!F,A="state"in s,u=D.defineProperty,R=y({},"t")?{}:g.createElement("a"),o=
