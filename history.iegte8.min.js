...
a===d.length-1&&2===(b=d[a].src.split("?")).length&&(b[2]=b[1])&&b){a=0;for(d=b[2].split("&");d[a];)b=d[a++].split("="),e[b[0]]="true"==b[1]?w:"false"==b[1]?o:b[1]||"";e.basepath=e.basepath||"/";break}return e}(),h=function(a){var d,k,e,c,j,i,m,o=RegExp("^"+s.basepath,"i");return function(f,n){if(f){if(!l)var G=h(),N=G.e,T=G.i,f=/^(?:[a-z]+\:)?\/\//.test(f)?0===f.indexOf("/")?T+f:f:T+"//"+G.h+(0===f.indexOf("/")?f:0===f.indexOf("?")?N+f:0===f.indexOf("#")?N+G.f+f:N.replace(/[^\/]+$/g,"")+f)}else if(f=
b.href,!l||n)f=b.protocol+"//"+b.host+s.basepath+(f.replace(/^[^#]*/,"")||"#").replace(RegExp("^#[/]?(?:"+s.type+")?"),"");if(d!==f){a.href=d=f;i=a.port;j=a.host;m=a.pathname;if("http:"===a.protocol&&80==i||"https:"===a.protocol&&443==i)j=a.hostname,i="";m=0===m.indexOf("/")?m:"/"+m;k=m+a.search+a.hash;c=m.replace(o,s.type)+a.search;e=c+a.hash}return{a:a.protocol+"//"+j+k,i:a.protocol,h:j,j:a.hostname||b.hostname,k:i||b.port,e:m,f:a.search,d:a.hash,b:k,c:c,g:e}}}(p.createElement("a")),k=!v?i:{back:i.back,
