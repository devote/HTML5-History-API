...
(a||"").replace(/^#/,""));b&&(b.id===a&&"A"===b.nodeName)&&(a=b.getBoundingClientRect(),e.scrollTo(F.scrollLeft||0,a.top+(F.scrollTop||0)-(F.clientTop||0)))}function ba(){var a=g.getElementsByTagName("script"),a=(a[a.length-1]||{}).src||"";(-1!==a.indexOf("?")?a.split("?").pop():"").replace(/(\w+)(?:=([^&]*))?/g,function(a,b,c){c=(c||"").replace(/^(0|false)$/,"");l[b]="basepath"===b?c.replace(/(?:^|\/)[^\/]*$/,"/"):c});o(r+"hashchange",M,n);var b=[J,Q,ca,e,R,h];B&&delete R.state;for(var c=0;c<b.length;c+=
2)for(var d in b[c])if(b[c].hasOwnProperty(d))if("function"===typeof b[c][d])b[c+1][d]=b[c][d];else{a=X(b[c],d,b[c][d]);if(!z(b[c+1],d,a,function(a,d){if(d===h)e.history=h=b[c+1]=a}))return K(r+"hashchange",M,n),n;b[c+1]===e&&(s[d]=s[d.substr(2)]=[])}l.redirect&&h.redirect();!B&&y&&W();if(!p)g[G](r+"click",aa,n);"complete"===g.readyState?O(i):(!p&&k().c!==l.basepath&&(C=i),o(r+"load",O,n));return i}if(e.history){var g=e.document,F=g.documentElement,E=e.Object,y=e.JSON,f=e.location,q=e.history,h=q,
H=q.pushState,S=q.replaceState,p=!!H,B="state"in q,u=E.defineProperty,Q=z({},"t")?{}:g.createElement("a"),r="",G=e.addEventListener?"addEventListener":(r="on")&&"attachEvent",T=e.removeEventListener?"removeEventListener":"detachEvent",U=e.dispatchEvent?"dispatchEvent":"fireEvent",o=e[G],K=e[T],$=e[U],l={basepath:"/",redirect:0,type:"/"},x="__historyAPI__",I=g.createElement("a"),w=f.href,N="",C=n,m={},s={},t=g.title,ca={onhashchange:j,onpopstate:j},V=function(a,b){var c=e.history!==q;c&&(e.history=
q);a.apply(q,b);c&&(e.history=h)},R={redirect:function(a,b){l.basepath=b=(""+(b==j?l.basepath:b)).replace(/(?:^|\/)[^\/]*$/,"/");l.type=a=a==j?l.type:a;if(e.top==e.self){var c=k(j,n,i).c,d=f.pathname+f.search;p?(d=d.replace(/([^\/])$/,"$1/"),c!=b&&RegExp("^"+b+"$","i").test(d)&&f.replace(c)):d!=b&&(d=d.replace(/([^\/])\?/,"$1/?"),RegExp("^"+b,"i").test(d)&&f.replace(b+"#"+d.replace(RegExp("^"+b,"i"),a)+f.hash))}},pushState:function(a,b,c){var d=g.title;t!=j&&(g.title=t);H&&V(H,arguments);v(a,c);g.title=
d;t=b},replaceState:function(a,b,c){var d=g.title;t!=j&&(g.title=t);delete m[f.href];S&&V(S,arguments);v(a,c,i);g.title=d;t=b},location:{set:function(a){e.location=a},get:function(){return p?f:Q}},state:{get:function(){return m[f.href]||j}}},J={assign:function(a){0===(""+a).indexOf("#")?v(j,a):f.assign(a)},reload:function(){f.reload()},replace:function(a){0===(""+a).indexOf("#")?v(j,a,i):f.replace(a)},toString:function(){return this.href},href:{get:function(){return k().b}},protocol:j,host:j,hostname:j,
port:j,pathname:{get:function(){return k().d}},search:{get:function(){return k().e}},hash:{set:function(a){v(j,(""+a).replace(/^(#|)/,"#"),n,w)},get:function(){return k().a}}};ba()&&(h.emulate=!p,e[G]=Y,e[T]=Z,e[U]=A)}})(window);
