...
(a.__defineGetter__(b,j.get),a.__defineSetter__(b,j.set),a[b]=a[b],c.get&&a.__defineGetter__(b,c.get),c.set&&a.__defineSetter__(b,c.set)),!g||!i){if(f)return n;if(a===e){try{var o=a[b];a[b]=k}catch(q){}if("execScript"in e)e.execScript("Public "+b,"VBScript"),e.execScript("var "+b+";","JavaScript");else try{v(a,b,{value:F})}catch(r){}a[b]=o}else try{try{var m=G.create(a);v(G.getPrototypeOf(m)===a?m:a,b,c);for(var p in a)"function"===typeof a[p]&&(m[p]=a[p].bind(a));try{d.call(m,m,a)}catch(s){}a=m}catch(t){v(a.constructor.prototype,
